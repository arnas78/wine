...
const Navbar = () => {
  ...
  return (
    <header
      className={`w-full z-40 py-4 fixed top-0 backdrop-blur-lg backdrop-saturate-150  ${pathname === "/wine" ? "bg-secondary/70" : "bg-background/70"}`}
    >
      <nav className="mx-auto max-w-[1280px] sticky flex justify-between items-center h-[40px]">
        <Link
          className="flex-1 flex items-center gap-2 font-Quattrocento text-2xl text-accent font-bold"
          href="/"
        >
          <svg
            height="24px"
        ...
        <div className="flex-1 flex justify-end items-center gap-6">
          ...
          <Link href="/checkout">
            <div
              className={`cursor-pointer ${pathname === "/wine" ? "bg-background" : "bg-secondary"} rounded-lg flex justify-center items-center px-3 py-2 gap-2 shadow`}
            >
              <ShoppingBasket01Icon color="#4E4446" size={24} />
