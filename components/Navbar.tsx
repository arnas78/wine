...
const Navbar = () => {
  ...
  return (
    <header className={`w-full z-10 pt-8 `}>
      <nav className="mx-auto max-w-[1280px] flex justify-between items-center h-[40px] ">
        <Link
        ...
        <div className="flex-1 flex justify-end items-center gap-6">
          ...
          <div
            className={`cursor-pointer ${pathname === "/wine" ? "bg-background" : "bg-primary"} rounded-lg flex justify-center items-center px-3 py-2 gap-2 shadow`}
          >
